...
export async function POST(request: NextRequest) {
  try {
    ...
    const leadData = {
      ...
      commercial_type: body.commercial_type ? sanitizeInput(body.commercial_type) : null,
      consent_tcpa: body.consent_tcpa,

      // Attribution params (only include if provided)
      utm_source: body.utm_source ? sanitizeInput(body.utm_source) : null,
      utm_medium: body.utm_medium ? sanitizeInput(body.utm_medium) : null,
      utm_campaign: body.utm_campaign ? sanitizeInput(body.utm_campaign) : null,
      utm_term: body.utm_term ? sanitizeInput(body.utm_term) : null,
      utm_content: body.utm_content ? sanitizeInput(body.utm_content) : null,
      gclid: body.gclid ? sanitizeInput(body.gclid) : null,
      gbraid: body.gbraid ? sanitizeInput(body.gbraid) : null,
      wbraid: body.wbraid ? sanitizeInput(body.wbraid) : null,
    }
